...
def generate_waveforms(m1, m2, spin1x, spin1y, spin1z, spin2x, spin2y, spin2z, incl_angle, sky_theta, sky_phi, polarization_angl, f_low, f_final, fs, N, approx, amplO, phaseO, phi0=0., dataFileName=0, waveform_type=0, domain='freq', use_only_22=0, print_waveforms=0): 
