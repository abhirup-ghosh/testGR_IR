...
datfile = fopen('/home/abhirup/Documents/Work/testGR_IR/runs/paper_2_simulations/gaussian_noise/LALAdLIGO/2016-09-25/mass_list_paper_2_simulations.txt','r');
injfile = fopen('/home/abhirup/Documents/Work/testGR_IR/runs/paper_2_simulations/gaussian_noise/LALAdLIGO/2016-09-25/inj_thresh8_seglen16_paper_2_simulations_common.txt', 'r');
...
for n = inj_list(1:2)%1:length(m1m2)
    ...
    if savedat
        ...
        outfile = fopen(strcat('/home/abhirup/Documents/Work/testGR_IR/runs/paper_2_simulations/gaussian_noise/LALAdLIGO/2016-09-25/IHES_waveforms_common_injections/injection_',int2str(n),'_GR.dat'),'w');
	...
	outfile2 = fopen(strcat('/home/abhirup/Documents/Work/testGR_IR/runs/paper_2_simulations/gaussian_noise/LALAdLIGO/2016-09-25/IHES_waveforms_common_injections/injection_',int2str(n),'_Mbhabh_GR.dat'),'w');
