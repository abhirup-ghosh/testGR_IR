function varargout = EOBRun_DIN_mod( nu, ...
...
%Mbh = 0.97197483; %0.9680292575; %Consistent value for q = 4, fac = 1.5 with lmax = 7 (with q = 4, fac = 2.0 commented out)
%abh = 0.44210176; %0.4194864278; %Ibid
%Mbh = 0.973742 - 0.0242734*EOBopt.fac + 0.00261714*EOBopt.fac^2; %0.9476; %0.9433; %0.9358; %0.935616; % The value with the consistency correction for the fit to q = 1 (fac = 1.25, 1.5 and 2, and 2 with more accuracy commented out)
%abh = 0.802125 - 0.123465*EOBopt.fac + 0.0120145*EOBopt.fac^2; %0.6669; %0.6445; %0.6030; %0.602832; % Ibid!
%Mbh = 0.95478170; %0.95026153; %0.9421503; % Consistent value for q = 2, a1 = 5 (a1 = 10 and 20 commented out; fac = 1)
%abh = 0.60231575; %0.58342458; %0.5482489; % Ibid
%Mbh = 0.92838130; %0.944120649; %0.93761580; %0.92838130; % Consistent value for q = 1, a2 = 5 (a2 = 10 and 20 commented out) (fac = 1)
%abh = 0.62130346; %0.669614665; %0.65087419; %0.62130346; % Ibid
%Mbh = 0.954040274; %0.9494337578; %0.94246311; % Consistent value for q = 2, a2 = 5 (a2 = 10 and 20 commented out; fac = 1)
%abh = 0.602804675; %0.5863037085; %0.55913392; % Ibid
Mbh = 0.913001960; % Consistent value for q = 1, iQNMfac = 0.6 (all other modification parameters set to 1)
abh = 0.585421019; % Ibid
...
if verbose
    ...
    %fprintf('Jbh fractional error = %+.2e\n',abh*Mbh^2/(abhrad*Mbhrad^2)-1);
