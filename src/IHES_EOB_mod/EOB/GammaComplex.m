...
%GammaComplex Gamma function valid in the entire complex plane.
%
%   f = GammaComplex(z)
%
...
%   Sept 11, 2001
%
%   Accuracy is 15 significant digits along the real axis and 13
%   significant digits elsewhere. This routine uses a superb Lanczos
%   series approximation for the complex Gamma function.
%
