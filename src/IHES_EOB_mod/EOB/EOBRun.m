...
EOBopt = EOBSet(defaultopt, EOBopt );
...
switch EOBopt.Dynamics
    case 'eob'
        ...
        EOBopt.ComputeID     = @EOBIdPostAdiab;                
    case 'particle'
...
switch EOBopt.RadReac
    ...
    case 'din_mod'
            EOBopt.ComputeRRForce = @EOBRRDINMOD;
    case 'pn'
...
if strcmp(lower(EOBopt.RadReac),'din') ...
