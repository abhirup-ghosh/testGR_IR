...
r0   = 32; %80; %32; % 16;  % Initial radius
tmax = 100000; %110000; %500000; %2100000; %100000; % 10000 % Final time
...
options =EOBSet_mod('Dynamics','eob',...
    ...
    'a2',1.0,...
    'iQNMfac',0.6,...
    'NQCFileNR','/Users/nkjm/testing_GR/testGR_IR/src/IHES_EOB_mod/DataNR/NRpts4NQC.dat',...
    'QNMDataDir','/Users/nkjm/testing_GR/testGR_IR/src/IHES_EOB_mod/DataQNM/',....
    'textend',500,...
    'ODEEventFunRmin',1.5,...
...
out = EOBRun_DIN_mod(nu, ainput, r0,tmax,dt, nQNM,lmaxQNM, options, modus, verbose,  saveme, 'tmp_DIN_mod_q2s_fac2')
...
if savedat
    ...
    outfile = fopen('/Users/nkjm/testing_GR/testGR_IR/src/IHES_EOB_mod/waveforms/q1_iQNMfac_06_r0_32.dat','w');
