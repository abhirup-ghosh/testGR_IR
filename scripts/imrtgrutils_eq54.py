...
def calc_final_mass_spin(m1, m2, chi1, chi2, fit_formula):
  ...
  if fit_formula == 'nospin_Pan2011':
    ...
    chif = nr.bbh_final_spin_non_precessing_Healyetal(m1, m2, chi1, chi2, version="2014")
    mf = nr.bbh_final_mass_non_precessing_Healyetal(m1, m2, chi1, chi2, version="2014", chif=chif)
