...
fit_formula = 'nonprecspin_Healy2014_mass_BR_spin'
#fit_formula = 'precspin_Zlochower2015'
#fit_formula = 'precspin_Zlochower2015test'
#fit_formula = 'precspin_Zlochower2015_new_AC'

# # parameters for selecting only the non-precessing spins
# out_dir = '2015-12-04_non_prec_spin'
# tag = 'non_prec_spin_%s_test' %fit_formula
...
tag = 'allspins_incl_in-plane_spin_no_evol_L0ADM_corr_%s' %fit_formula
...
chi1inplanex = chi1_x - chi1dL0*Lx
chi1inplaney = chi1_y - chi1dL0*Ly
chi1inplanez = chi1_z - chi1dL0*Lz

chi2inplanex = chi2_x - chi2dL0*Lx
chi2inplaney = chi2_y - chi2dL0*Ly
chi2inplanez = chi2_z - chi2dL0*Lz
...
Mf_fit, af_HLZ_fit = nrf.bbh_final_mass_and_spin_non_precessing(m1, m2, chi1dL0, chi2dL0) # This is just to get the final mass, to simplify the coding
#af_fit = nrf.bbh_final_spin_precessing_Barausse_and_Rezzolla(m1, m2, chi1, chi2, np.arccos(chi1dL/chi1), np.arccos(chi2dL/chi2),phi12) # The Barausse and Rezzolla fit for the final spin
af_fit = nrf.bbh_final_spin_precessing_Barausse_and_Rezzolla(m1, m2, chi1, chi2, np.arccos(chi1dL0/chi1), np.arccos(chi2dL0/chi2),phi12) # The Barausse and Rezzolla fit for the final spin
#Mf_fit, af_fit = nrf.bbh_final_mass_and_spin_ZL_precessing(m1, m2, chi1, chi2, np.arccos(chi1dL/chi1), np.arccos(chi2dL/chi2),phi12) # The Zlochower and Lousto fit
#Mf_fit, af_fit = nrf.bbh_final_mass_and_spin_ZL_precessing_test(m1, m2, chi1, chi2, np.arccos(chi1dL/chi1), np.arccos(chi2dL/chi2),phi12) # The Zlochower and Lousto fit
#af_fit = nrf.bbh_final_spin_ZL_precessing_new_AC(m1, m2, chi1, chi2, np.arccos(chi1dL0/chi1), np.arccos(chi2dL0/chi2),phi12) # Version 1 of the revised Zlochower and Lousto fit (private communication from Yosef)
