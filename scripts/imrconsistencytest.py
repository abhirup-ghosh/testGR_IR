...
parser.add_option("-f", "--fit-formula", dest="fit_formula",
                  help="fitting formula to be used for the calculation of final mass/spin [options: 'nospin_Pan2011', 'nonprecspin_Healy2014'")
parser.add_option("-p", "--mf-af-prior", dest="prior_Mfaf_file",
                  help="pickle file containing the interpolation object of the prior in (Mf,af) used in the lalinference runs")
parser.add_option("-o", "--out-dir", dest="out_dir",
                  help="output directory")
parser.add_option("--insp-fhigh", dest="insp_fhigh", 
									help="Upper cutoff freq for the inspiral analysis")
parser.add_option("--ring-flow", dest="ring_flow", 
									help="Lower cutoff freq for the ringdown analysis")
parser.add_option("-M", "--mtot-inj", dest="M_inj", 
									help="injected value of total mass (if this is an injection)")
parser.add_option("-Q", "--mratio-inj", dest="q_inj", 
									help="injected value of mass ratio (if this is an injection)")
parser.add_option("--chi1-inj", dest="chi1_inj",
									help="injected value of spin of mass m1 (if this is an injection)")
parser.add_option("--chi2-inj", dest="chi2_inj",
									help="injected value of spin of mass m2 (if this is an injection)")
parser.add_option("-w", "--waveform", dest="waveform", 
									help="waveform used for recovery")
