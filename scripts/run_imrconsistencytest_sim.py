...
for idx in range(200):
	...
	print noise_data[idx]['o2_L1H1V1_512_geocentric_times'], m1, m2, s1x, s1y, s1z, s2x, s2y, s2z, post_loc
	...
	try:
		...
		run_cmd = 'python /home/abhirup/opt/lalsuite_master_20190628_e5b55248/libexec/lalinference/imrtgr_imr_consistency_test.py --insp-post=%s --ring-post=%s --imr-post=%s --fit-formula=bbh_average_fits_precessing --out-dir=%s --m1-inj=%f --m2-inj=%f --chi1-inj=%f --chi2-inj=%f --chi1z-inj=%f --chi2z-inj=%f --phi12-inj=%f --insp-fhigh=%f --ring-flow=%f --waveform=IMRPhenomPv2 --N_bins=401 --dMfbyMf_lim=2 --dchifbychif_lim=2 --use_KDE=0' %(post_samples_i, post_samples_r, post_samples_imr, out_dir, m1, m2, s1, s2, s1z, s2z, phi12, f_isco, f_isco)
